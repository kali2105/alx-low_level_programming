...
/**
 * f4 - The function that finds the biggest number
 *
 * @usrn: Username
 ...
 * @usrn: Username
 * @len: the length of username
 * Return: return the multiplied char vrb
 */
...
/**
 * f6 - A function that generates a random char variable
 *
 * @usrn: Username
 * Return: return a random char vrb
 */
int f6(char *usrn)
{
	int ch;
